...
class Player extends Component {
  ...
  render() {
    const {scatterDataName, scatterData, changeScatterData, setHighlightedPoint, highlightedPoint, changePlayer, player} = this.props
    const playerOptions = [
...
const mapStateToProps = (state) => {
  const {scatterDataName, scatterData, highlightedPoint, player} = state.player
  return {
    scatterDataName,
    scatterData,
    highlightedPoint,
